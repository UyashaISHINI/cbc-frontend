...
export default function Header(){
    ...
    return(
        ...
        <header className="bg-secondary w-full h-[80px] relative flex justify-center items-center">
            <img src="/logo.png" className="cursor-pointer h-full rounded-full absolute left-[10px]"/>
            <RxHamburgerMenu onClick={()=>{setIsSliderOpen(true)}}className="text-3xl absolute right-[10px] lg:hidden text-accent"/>
