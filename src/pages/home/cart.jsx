...
export default function Cart(){
    ...
    return(
        <div className="w-full h-full overflow-y-scroll flex flex-col items-end">
            ...
            <h1 className="text-3xl font-bold text-secondary">Total: LKR. {labeledTotal.toFixed(2)}</h1>
            <h1 className="text-3xl font-bold text-secondary">Discount: LKR. {(labeledTotal-total).toFixed(2)}</h1>
            <h1 className="text-3xl font-bold text-secondary">Grand Total: LKR. {total.toFixed(2)}</h1>
